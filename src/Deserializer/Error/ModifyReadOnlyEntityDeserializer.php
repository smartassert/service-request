    ...
    public function deserialize(string $class, array $data): ?ErrorInterface
    {
        ...
        if (!array_key_exists('entity', $data)) {
            throw new ErrorDeserializationException(
                $class,
                new DeserializationException('entity', $data, DeserializationException::CODE_MISSING)
            );
        }
        ...
        if (!array_key_exists('id', $entityData)) {
            throw new ErrorDeserializationException(
                $class,
                new DeserializationException('entity.id', $data, DeserializationException::CODE_MISSING)
            );
        }
        ...
        if ('' === $entityId) {
            throw new ErrorDeserializationException(
                $class,
                new DeserializationException('entity.id', $data, DeserializationException::CODE_EMPTY)
            );
        }
        ...
        if (!array_key_exists('type', $entityData)) {
            throw new ErrorDeserializationException(
                $class,
                new DeserializationException('entity.type', $data, DeserializationException::CODE_MISSING)
            );
        }
